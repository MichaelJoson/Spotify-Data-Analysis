...
The original dataset contains 36 attributes which was reduced to the 12 audio features from [Spotify's API](https://developer.spotify.com/documentation/web-api/reference/#/operations/get-several-audio-features) in our train and test set that were used to test on the following models:
